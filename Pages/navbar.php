					...
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="index.php">
								<img src="assets/images/brand/logo.png" class="header-brand-img d-none d-sm-block" alt="Spain logo"><img src="assets/images/brand/logo.png" class="header-brand-img-2 d-sm-none" alt="Spain logo">
							</a>
								...
								<div class="dropdown">
									...
									<!-- 	<a class="dropdown-item" href="#">
										...
										<a class="dropdown-item" href="deconnexion.php">
											<i class="dropdown-icon mdi  mdi-logout-variant"></i>Se deconnecté
										</a>
									</div>
								</div>
							</div>
