...
if(!empty($_GET['id'])){
   ...
   //var($user);
    ...
    $sth=$dbc->prepare(" SELECT * FROM organisations ORDER BY id ASC");
							...
							<div class="row justify-content-center">
								<div class="col-md-8">
									<div class="card-group mb-0">
										<div class="card p-4">
											<div class="card-body">
												<center><h3>METTRE A JOUR LES RENSEIGNEMENTS DU MEMBRE DE L'ORGANISATION</h3></center>
												<!-- <p class="text-muted">Create New Account</p> -->
												<form action="Exe/edit/Membre.php" method="">
												...
												<div class="input-group mb-4">
													...
													<input type="text" class="form-control" name="prenoms" value="<?=$user['prenoms']?>" placeholder="Entre votre prenoms">
												</div>
												<div class="input-group mb-4">
													...
													<input type="text" class="form-control" name="telephone"  value="<?= $user['telephone']?>" placeholder="Enter telephone">
												</div>
												<div class="input-group mb-4">
													
													<input type="text" class="form-control" name="email"  value="<?= $user['email']?>" placeholder="Mot de passe">
												</div>
												<div class="input-group mb-4">
												...
												<div class="input-group mb-3">
												<select class="input-group mb-3" name="organisations_name" value="<?=$user['type_organisations']?>">
													<option><?=$user['organisations_name']?></option>
												<?php
												...
												<div class="row">
													<div class="col-12">
														...
														<a class="btn btn-block btn-lg btn-danger" href="?C=membre&M=list"></i>ANNULER</a>
													</div>
