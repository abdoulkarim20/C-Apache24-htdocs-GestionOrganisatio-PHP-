							...
							<div class="row justify-content-center">
								<div class="col-md-8">
									<div class="card-group mb-0">
										<div class="card p-4">
											<div class="card-body">
												<center><h3>MODIFICATION OU MISE A JOUR</h3></center>
												<!-- <p class="text-muted">Create New Account</p> -->
												<form action="Exe/edit/User.php" method="">
													<input type="hidden" class="form-control" name="id" placeholder="Entre votre Nom" name="id" value="<?=$user['id']?>">
												<div class="input-group mb-3">
												<select class="input-group mb-3" name="Groupe_User" value="<?=$user['Groupe_User']?>">
													<option><?=$user['Groupe_User']?></option>
												<?php
												...
												<div class="input-group mb-4">
												<select class="input-group mb-4" name="genre" value="<?=$user['genre']?>">
													...
													<input type="Email" class="form-control" name="username"  value="<?= $user['username']?>" placeholder="Enter username doit etre de type email">
												</div>
												<div class="input-group mb-4">
													<span class="input-group-addon"><i class="fa fa-unlock-alt  w-4"></i></span>
													<input type="password" class="form-control" name="password"  value="<?= $user['password']?>" placeholder="Mot de passe">
												</div>
												...
												<div class="row">
													<div class="col-12">
														...
														<a class="btn btn-block btn-lg btn-danger" href="?C=user&M=list"></i>ANNULER</a>
													</div>
