									...
									<div class="card-group mb-0">
										<div class="card p-4">
											<div class="card-body">
												...
												<form action="Exe/edit/Groupe.php" method="">
												...
												<div class="input-group mb-4">
													...
													<div class="input-group mb-4">
													<span class="input-group-addon"><i class="fa fa-user  w-4"></i></span>
													<input type="text" class="form-control" name="description" value="<?= $user['description']?>" placeholder="Entre votre Prenoms">
												</div>
												...
												<div class="row">
													<div class="col-12">
														...
														<a class="btn btn-block btn-lg btn-danger" href="?C=groupe&M=list"></i>ANNULER</a>
													</div>
