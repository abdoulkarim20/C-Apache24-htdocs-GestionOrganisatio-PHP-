							...
							<div class="row justify-content-center">
								<div class="col-md-8">
									<div class="card-group mb-0">
										<div class="card p-4">
											<div class="card-body">
												<center><h3>CEER UN NOUVEAU GROUPE</h3></center>
												
												<!-- <p class="text-muted">Create New Account</p> -->
												<form action="Exe/add/Groupe.php" method="POST">
										
												<div class="input-group mb-4">
													<span class="input-group-addon"><i class="fa fa-user  w-4"></i></span>
													<input type="text" class="form-control" name="nom" placeholder="Nom du groupe">
												</div>
													<div class="input-group mb-4">
													<span class="input-group-addon"><i class="fa fa-user  w-4"></i></span>
													<input type="text" class="form-control" name="description" placeholder="description courte du groupe">
												</div>
												...
												<div class="row">
													<div class="col-12">
														<button type="submit" class="btn btn-gradient-success btn-block px-4">CREER LE GROUPE</button>
